...
namespace HappyDungeon.UI
{
    ...
    /// </summary>
    public class LargeBR : IText
    {
        private const int HEIGHT = 11; 

        private Texture2D sourceTexts;
        ...
        private Dictionary<char, int> alpLowerWidth = new Dictionary<char, int>
        {
            {'a', 6 },
            {'b', 6 },
            {'c', 6 },
        ...
        private Dictionary<char, int> alpCapWidth = new Dictionary<char, int>
        {
            {'A', 7 },
            {'B', 7 },
            {'C', 7 },
        ...
        private Dictionary<char, int> puncWidth = new Dictionary<char, int> 
        {
            {'!', 3 },
            {'\"', 3 },
            {'\'', 3 },
        ...
        private int GetCharWidth(char TarChar)
        {
        ...
        private int GetSrcLocation(char TarChar)
        {
        ...
        private Texture2D GetCharTexture(char TarChar, GraphicsDevice G)
        {
